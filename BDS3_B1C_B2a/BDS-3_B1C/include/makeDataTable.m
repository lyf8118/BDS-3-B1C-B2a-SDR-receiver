...
%Function generates BDS-3 B1C data BOC(1,1) codes for specified PRN based
...
%   Outputs:
%       DataCodesTable  - sampled BDS-3 B1C data BOC(1,1) spreading waveform
%                         
...
%--- Generate B1C BOC(1,1) code for given PRN -----------------------------
