...
% up acquisition.
settings.acqSatelliteList   = [19 20];         % [PRN numbers]
...
% Freq.search step
settings.acqStep            = 400;             % [Hz]

% Number of codes for fine qcquisition of carrier Dopper 
settings.fineNoncoh         = 15;              % [Hz]
